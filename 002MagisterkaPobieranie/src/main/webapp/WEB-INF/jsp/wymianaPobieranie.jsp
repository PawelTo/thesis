		...
		<c:when test="${mode == 'MODE-POBIERANIE-DATA-HTML'}">
			<div class="container text-center">
				...
				<form class="form-horizontal" method="post"
					action="pobieranieWymianaHTML">
					<div class="form-group">
						<label class="control-label col-md-3">Wymiana
							Miedzysystemowa - ustaw date do pobrania</label>
						<div class="col-mid-7">
		...
		<c:when test="${mode == 'MODE-POBIERANIE-DATA-CSV'}">
			<div class="container text-center">
				...
				<form class="form-horizontal" method="post"
					...
					<p>
						Pamietaj, zeby plik mial odpowiednia forme <br> 
						oraz umieszczony zostal w odpowiedniej lokalizacji. <br>
						Lokalizacja: "C:\wymSQL\" <br> 
						Nazwa Pliku: WYMIANA-RRRR-MM-DD
					</p>
					<div class="form-group">
						<input type="submit" class="btn btn-primary" value="pobierz">
					</div>
